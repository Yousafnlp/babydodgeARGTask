...
function HeaderLaptop() {
  return (
    ...
    <>
        <div className='mybg'>
            <div className="grid  grid-cols-1 gap-2 md:grid-cols-1 lg:grid-cols-2 container  flex justify-center items-center ">
                ...
                <div>
                    <div className='flex justify-center flex-col p-4'>
                        ...
                        <div className='flex items-center btn1-cover flex-wrap items-center mt-3'>
                            <button class="bg-transparent font-bold w-[208px] text-lg h-[47px] flex justify-center items-center text-white me-1 border-cstm1 py-2">
                                <img src={require('../assets/Bd 1.png')} className='w-[121px] m-1 p-1' alt="" />
                            </button>
                            <button class="bg-transparent font-bold text-lg w-[208px] h-[47px] text-white ms-2 flex justify-center items-center btn2-cover border-cstm1 py-2">
