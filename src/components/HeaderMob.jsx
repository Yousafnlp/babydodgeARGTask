  ...
  return (
    ...
    <div className="">               
                <div>
                    ...
                    <img className='w-7/12' style={{maxWidth: "450px"}} src='https://babydoge.katanainu.com/static/media/Babydoge_x_Katanainu.8b1e2178435316562627.png' alt="" />
                        <img className='w-7/12' style={{maxWidth: "450px"}} src={require('../assets/Group 40746.png')} alt="" />
                ...
                <div>
                    ...
                    <img className='w-full' style={{maxWidth: "500px"}} src={require('../assets/babydoge_Viewport_021 1.png')} alt="" />
                            ...
                            Whitelist Now
                                    ...
                                    <div>
                                        ...
                                        {isPopupOpen && (
                                            ...
                                            <div className="  items-center 	w-[90%]   absolute z-10 top-[90%] left-2/4 " style={{ transform: "translate(-50%, -50%)" }}>
<form>
                        ...
                        <div className='flex  justify-center  items-center w-full mt-2 '>
                            <Link to='https://babydogeswap.com/' target='_blank' class="bg-transparent font-bold w-6/12 sm:w-[208px] lg:w-[208px] md:w-[208px] text-lg h-[47px]  flex justify-center items-center text-white mr-1 border-cstm1 p-2">
                                <img src={require('../assets/Bd 1.png')} className='w-[121px] m-2  p-1' alt="" />
                            </Link >
                            <Link  to='https://katanainu.com/' target='_blank' class="bg-transparent font-bold text-lg w-6/12 lg:w-[208px] md:w-[208px] sm:w-[208px]  h-[47px] text-white   flex justify-center items-center  btn2-cover border-cstm1 p-2">
